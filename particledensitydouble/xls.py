#
#    Module      : xls.py
#    Description : A simple csv module look-a-like Excel sheet writer. Uses the
#                  pyExcelerator module to write to Excel sheets, in a manner
#                  similar to the csv module.
